...
document.getElementById("weatherForm").addEventListener("submit", async (e) => {
    ...
    <div>
        🌡️ Temp: ${(result.temperature - 273.15).toFixed(1)} °C<br>
        💧 Humidity: ${result.humidity}%<br>
        🐈💨 Wind: ${(result.windSpeed * 3.6).toFixed(1)} km/h, direction ${result.windDirection}°<br>
        ☁️ Weather: ${result.description}<br>
